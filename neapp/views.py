...
class AddPage(LoginRequiredMixin, View):      #63. Наследуемый класс LoginRequiredMixin накладывает ограничение на страницу Добавления Статей для неавторизированных пользователей.
